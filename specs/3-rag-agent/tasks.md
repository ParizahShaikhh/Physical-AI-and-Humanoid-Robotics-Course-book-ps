# Tasks for RAG Agent with OpenAI Agents SDK
...
- Spec-2 retrieval pipeline (book-backend/retrieve.py)
...
- [x] T007 Import and test SemanticRetriever from book-backend
